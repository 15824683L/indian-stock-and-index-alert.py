...
INDIAN_STOCKS = [
    ...
    "ASIANPAINT.NS", "BAJFINANCE.NS", "HCLTECH.NS", "MARUTI.NS", "SUNPHARMA.NS", "NESTLEIND.NS",
    "WIPRO.NS", "TITAN.NS", "ULTRACEMCO.NS", "HDFCLIFE.NS", "POWERGRID.NS", "TECHM.NS",
    "ONGC.NS", "NTPC.NS", "COALINDIA.NS", "JSWSTEEL.NS", "TATASTEEL.NS", "BPCL.NS",
    "BRITANNIA.NS", "DIVISLAB.NS", "ADANIENT.NS", "ADANIPORTS.NS", "GRASIM.NS", "CIPLA.NS",
    "EICHERMOT.NS", "HEROMOTOCO.NS", "HINDALCO.NS", "DRREDDY.NS", "BAJAJFINSV.NS", "SBILIFE.NS",
    "BAJAJ-AUTO.NS", "INDUSINDBK.NS", "M&M.NS"
]
...
def liquidity_grab_with_vwap(df):
    ...
    df['vwap_sustain'] = (df['close'] > df['vwap']) & (df['close_shift'] > df['vwap'])
    df['vwap_fall'] = (df['close'] < df['vwap']) & (df['close_shift'] < df['vwap'])
